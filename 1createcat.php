    ...
    elseif (preg_match('/[0-9]/',$cname))
        {
            ...
            $cname = $_POST['cname'];
            // echo $cname;
            $sql= "INSERT INTO `productsdet` (`cname`) VALUES ('$cname');";
...
// header("Location: 1createcat.php");
?>
<style>
.error{
    color: red;
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>">
    <!-- <form action="2insertcat.php" method="POST"> -->
        ...
        <button class="button" type="submit" name="submit" method="POST"> submit</button>
        <button class="button" ><a class="an" href="3displaycat.php">List Categories</a></button>
    <!-- </form> -->
</form>
