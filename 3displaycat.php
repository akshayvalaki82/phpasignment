...
<button class=" button an "> <a class ='an' href='1createcat.php'>Create Category</a></button>
<button class=" button an "> <a class ='an' href='mainpage.php'>Product Category</a></button> <br> <br>
<table class="table table-bordered">
  ...
  <tbody>
      ...
      while($row= mysqli_fetch_assoc($result)){
            ...
            <th scope='row'>".$sno."</th>
            <td>".$row['cname']."</td>
            <td><button class='button'><a class ='an' href='4editcat.php?srno=$row[srno]'>EDIT</a></button>  <button class= ' button an '><a class ='an' href='6deletecat.php?srno=$row[srno]'>Delete</a></button></td>
            </tr>";
        }
    ?>
  </tbody>
