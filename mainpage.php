...
if($_SERVER["REQUEST_METHOD"] == "POST"){
        ...
        elseif (preg_match('/[\'^£$%&*()}{@#~?><>,|=_+¬-]/',$pname))
            {
                $pnameerr = "*not allowed special characters ";
            }
        elseif (preg_match('/[0-9]/',$pname))
            {
                $pnameerr = "*not allowed number";
            }
        ...
        elseif (preg_match('/[\'^£$%&*()}{@#~?><>,|=_+¬-]/',$pprice))
            {
                $ppriceerr = "*not allowed special characters ";
            }
        elseif (preg_match('/[a-z]+/',$pprice))
            {
                $ppriceerr = "*not allowed alphabets";
            }
        elseif (preg_match('/[A-Z]+/',$pprice))
            {
                $ppriceerr = "*not allowed alphabets";
                ...
                if($fileerror === 0){
                    if (in_array($fileactualext,$allowed)){
                        if($filesize < 1000000){
                            ...
                            $fileerr = "*file is to big";
                        }
                    }
                    else{
                        $fileerr = "*only jpg & png file allowed"; 
                    }
                }
                else{
                    $fileerr = "*required ";
...
<form method="POST" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype="multipart/form-data">
    <!-- <form action="upload.php" method="POST" enctype="multipart/form-data"> -->
        ...
        <span class="error"> <?php echo $scategoryerr; ?> </span>
        <br> <br>
